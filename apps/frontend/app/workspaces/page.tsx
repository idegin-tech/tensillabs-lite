                  ...
                  {isLoading ? (
                    ...
                    memberships.map((member) => {
                      ...
                      return (
                        <div
                          key={member._id}
                          onClick={() => handleWorkspaceClick(member)}
                        >
                            ...
                            <CardContent className="p-6">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
                                  <div
                                    ...
                                    style={{
                                      backgroundImage: `url(${member.workspace.logoURL || '/placeholders/logo.jpg'})`,
                                    }}
                                  ></div>
                                  ...
                                  <div className="flex-1 min-w-0 grid grid-cols-1">
                                    ...
                                    <div className="flex items-center space-x-4 mt-2 text-xs text-muted-foreground">
                                      ...
                                      <div className="flex items-center space-x-1">
                                        ...
                                        <span>{member?.permission?.replaceAll('_', ' ')}</span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              {isPending && (
                                <div className="text-xs text-muted-foreground bg-muted/50 rounded-md p-2">
                                  Click to accept your invitation to this
                                  workspace
                                </div>
                              )}
                            </CardContent>
