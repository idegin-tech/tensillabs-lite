...
export default function CreateLeaveRequestDialog({
    ...
    const createLeaveRequest = useMutation({
        mutationFn: async (data: { formData: LeaveRequestForm; files: File[] }) => {
    ...
    const onSubmit = async (values: LeaveRequestForm) => {
        ...
        await createLeaveRequest.mutateAsync({ formData: values, files: selectedFiles })
    }
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t">
                            ...
                            <Button
                                type="submit"
                                disabled={createLeaveRequest.isPending || hasPendingRequest}
                            >
